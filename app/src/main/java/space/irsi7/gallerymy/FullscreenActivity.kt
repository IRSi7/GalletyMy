...
class FullscreenActivity : AppCompatActivity() {
    ...
    private lateinit var binding: ActivityFullscreenTestBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityFullscreenTestBinding.inflate(layoutInflater)
        ...
        fullscreenContent = binding.imageContent
        fullscreenContent.setImageDrawable(Drawable.createFromPath(path))
